...
class PriorityTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $entity = new \SE\Component\Redmine\Entity\Relation\Priority;
    ...
    public function Serialize()
    {
        ...
        $expected = file_get_contents(__DIR__.'/Fixtures/priority_relation.xml');
    ...
    public function Serialize_Empty()
    {
        ...
        $expected = file_get_contents(__DIR__.'/Fixtures/priority_relation_empty.xml');
        $actual = $this->serializer->serialize($entity, 'xml');
    ...
    {
        $contents = file_get_contents(__DIR__.'/Fixtures/priority_relation.xml');
        $entity = $this->serializer->deserialize($contents, 'SE\Component\Redmine\Entity\Relation\Status', 'xml');

        $this->assertEquals(1, $entity->getId());
        $this->assertEquals('High', $entity->getName());
    }
    ...
    {
        $contents = file_get_contents(__DIR__.'/Fixtures/priority_relation_empty.xml');
        $entity = $this->serializer->deserialize($contents, 'SE\Component\Redmine\Entity\Relation\Status', 'xml');
