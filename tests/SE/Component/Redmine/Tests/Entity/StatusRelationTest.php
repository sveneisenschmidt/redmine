 ...
 */
class StatusRelationTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $entity = new \SE\Component\Redmine\Entity\Relation\Status;
    ...
    public function Serialize()
    {
        ...
        $expected = file_get_contents(__DIR__.'/Fixtures/status_relation.xml');
    ...
    public function Serialize_Empty()
    {
        ...
        $expected = file_get_contents(__DIR__.'/Fixtures/status_relation_empty.xml');
        $actual = $this->serializer->serialize($entity, 'xml');
    ...
    {
        $contents = file_get_contents(__DIR__.'/Fixtures/status_relation.xml');
    ...
    {
        $contents = file_get_contents(__DIR__.'/Fixtures/status_relation_empty.xml');
        $entity = $this->serializer->deserialize($contents, 'SE\Component\Redmine\Entity\Relation\Status', 'xml');
